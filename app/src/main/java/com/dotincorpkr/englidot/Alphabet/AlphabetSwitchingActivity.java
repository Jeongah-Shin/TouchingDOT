...
import static com.dotincorpkr.englidot.Alphabet.BrailleInsertActivity.dictation;
import static com.dotincorpkr.englidot.Alphabet.BrailleInsertActivity.presentAlphabet;

/**
 * Created by wjddk on 2017-02-13.
 */

public class AlphabetSwitchingActivity extends BaseActivity  {
    // TV - show
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.alphabet_switching);
    ...
    @OnClick({R.id.cheating1,R.id.cheating2,R.id.cheating3})
    void cheatKey(View v){
        k=1;
        switch (v.getId()) {
            case R.id.cheating1:
                position = max_num[0];
