...
import static com.dotincorpkr.englidot.Alphabet.AlphabetTestShortAnswerActivity.shortAnswerWrong;
import static com.dotincorpkr.englidot.Alphabet.AlphabetTestShortAnswerActivity.shortWrongAnswer_length;

/**
 * Created by wjddk on 2017-02-09.
 */

public class ShortTestResultActivity extends BaseActivity {
    TextView result;
    TextView wrongABC;
    Button gotoReview;
    int testScore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wrongABC.setText(shortAnswerWrong.toString());
        ...
        testScore = 5 - shortWrongAnswer_length;
        result.setText(testScore+"/5");

        insertToDatabase("S",Integer.toString(testScore), shortAnswerWrong.toString());
    ...
    private void insertToDatabase(String db_testArea, String db_testScore, String db_wrongAnswer){
        ...
        class InsertData extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ShortTestResultActivity.this, "Please Wait", null, true, true);
            }
